            ...
            <div class="col-md-8 mt-2">
                <div class="d-inline-flex">
                    ...
                    <div class="container mt-3">
                        <h5 class="w-100 samazon-favorite-item-text">{{App\Product::find($fav->favoriteable_id)->name}}</h5>
                        <h6 class="w-100samazon-favorite-item-text">￥{{App\Product::find($fav->favoriteable_id)->price}}</h6>
                    </div>
                </div>
            </div>
